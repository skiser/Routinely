...
import {getTopArticle} from '../services/news-service'
...
export default class NewsItem extends Component {
    ...
    render () {
        let article = JSON.stringify(this.data);
        let source = article.author;
        ...
        return (
            <ListItem thumbnail>
                <Left>
                    <Thumbnail source={{uri: article.urlToImage != null ? article.urlToImage :
                ...
                <Body>
                    ...
                    <ReadMore
                        ...
                        <Text style = {{color: '#616569'}}>{article.description}</Text> </ReadMore>
                    <Text note
                          style={{color: 'blue'}}> {source}        {time}</Text>
    ...
    _renderTruncatedFooter = (handlePress) => {
        return (
            <Text style={{color: '#b9bec9'}} onPress={handlePress}>
                Read more
            </Text>
        );
    };
